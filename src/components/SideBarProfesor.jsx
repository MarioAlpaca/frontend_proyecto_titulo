...
import { faBook, faEnvelope, faHistory } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="w-full md:w-1/4 lg:w-1/5 h-screen bg-white text-gray-800 flex flex-col items-start py-6 px-4 shadow-lg border-r">
            ...
            <ul className="w-full space-y-4">
                ...
                <li>
                    <Link
                        to="/profesor/solicitudes"
                        className={`flex items-center p-3 rounded-lg transition duration-200 ${
                            isActive("/profesor/solicitudes")
                                ? "bg-blue-100 text-blue-600"
                                : "bg-gray-100 hover:bg-gray-200 text-gray-700"
                        }`}
                    >
                ...
                <li>
                    <Link
                        to="/profesor/historial-solicitudes"
                        className={`flex items-center p-3 rounded-lg transition duration-200 ${
                            isActive("/profesor/historial-solicitudes")
                                ? "bg-blue-100 text-blue-600"
                                : "bg-gray-100 hover:bg-gray-200 text-gray-700"
                        }`}
                    >
                        <FontAwesomeIcon icon={faHistory} className="w-5 mr-3" />
