...
import SidebarAlumno from "../components/SidebarAlumno"; // Importar el SidebarAlumno

function HistorialSolicitudesAlumno() {
    ...
    const fetchHistorialSolicitudes = async () => {
        setIsLoading(true);
        try {
            const res = await api.get("subjects/solicitudes/historial_alumno/");
...
export default HistorialSolicitudesAlumno;
